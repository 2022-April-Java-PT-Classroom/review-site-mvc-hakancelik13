...
public class ReviewControllerMvcTest {
    ...
    @Test
    public void shouldBeOkForAllReviewsInTheModel() throws Exception {
    ...
    @Test
    public void shouldBeOkForOneReviewsInTheReviewsTemplate() throws Exception {
        Long reviewOneId = 1L;
    ...
    public void shouldFindReviewOneInModel() throws Exception {
        Long reviewOneId = 1L;
        when(reviewRepo.findOne(reviewOneId)).thenReturn(reviewOne);
        mockMvc.perform(get("/review?id=1")).andExpect(model()
                .attribute("reviewModel", reviewOne));
    }
    @Test
    public void shouldBeNotFoundForRequestNotInModel() throws Exception {
        Long reviewOneId = 2L;
        when(reviewRepo.findOne(reviewOneId)).thenReturn(reviewTwo);
